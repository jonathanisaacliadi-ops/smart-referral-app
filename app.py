...
def train_sophisticated_model(retrain=False):
    ...
    cat_names = calibrated.calibrated_classifiers_[0].base_estimator.named_steps['preprocessor'].named_transformers_['cat'].named_steps['onehot'].get_feature_names_out(categorical_features)
